export default {
  externalLinks: {
    ...
    appDevs: {
      sampleApps: {
        webHosting: 'https://github.com/maidsafe/safe_examples/tree/master/web_hosting_manager/',
    ...
    parsec: {
      resources: {
        ...
        rfc: 'https://github.com/maidsafe/rfcs/blob/master/text/0049-parsec/0049-parsec.md',
        whitepaper: 'http://docs.maidsafe.net/Whitepapers/pdf/PARSEC.pdf',
        documentation: 'https://docs.rs/parsec/0.4.0/parsec/'
      }
    }
  },
  locals: {
